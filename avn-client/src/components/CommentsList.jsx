...
export default function CommentsList({ publicacaoId, usuarioId, shouldReload }) {
  ...
  useEffect(() => {
    carregarComentarios();
  }, [publicacaoId, usuarioId, shouldReload]);
  ...
  const atualizarComentario = (comentarioAtualizado) => {
    ...
    setComentarios((prevComentarios) => {
      const novosComentarios = prevComentarios.map((c) =>
        c.comentarioId === comentarioAtualizado.comentarioId ? comentarioAtualizado : c
      );
